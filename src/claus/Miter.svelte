...
<svg width="269" height="298" style="transform: translate({$coords.x}px, {$coords.y}px) rotate({$coords.x}deg);">
  <defs>
    <g id="miter-cross">
  ...
  <path id="miter" d="M103.725 1l24.5 85h-49l24.5-85z" {fill} stroke="#000" stroke-width="2" />
